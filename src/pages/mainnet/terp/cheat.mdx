...
<input type="text" id="monikerInput" placeholder="YOUR_MONIKER_NAME">
<input type="text" id="identityInput" placeholder="YOUR_KEYBASE_ID">
<input type="text" id="detailsInput" placeholder="YOUR_DETAILS">
<input type="text" id="websiteInput" placeholder="YOUR_WEBSITE_URL">
<button onclick="generateCommand()">Generate Command</button>
<pre><code id="codeBox"></code></pre>

<script>
function generateCommand() {
  var moniker = document.getElementById("monikerInput").value;
  ...
  var command = `realio-networkd tx staking create-validator \\
    --amount=1000000ario \\
  ...
  document.getElementById("codeBox").textContent = command;
}
</script>
